...
<body onload=counter() >
	...
	<div class="internBackground">
		...
		<div class="presentation">
			<p>Save water and it will save you... Not only are we facing pollution issues with our water
				sources, but it is also estimated that we will run out of freshwater
				by the year 2040. Water just might be the single most important
				resource we have on planet Earth. Every animal, plant, and even
				micro-organism needs it to survive. Everything single item that we eat, buy, or use needs water to be
				produced.</p>

			<p>Here at FLOW, we want to protect this essential natural
				resource by raising awareness of water conditions, agricultural use,
				freshwater renewability and conservation, as well as tracking our
				own personal water footprint. Connect with us to create an account
				that will allow you to track your daily water consumption. You will
				then be able to compare it with daily averages
				from around the globe. We believe that holding oursleves accountable can bring individual changes. Waters may physically
				separate us from one another, but the only way we can protect it is by doing it together.
				</p>
		...
		<div class="api">
			...
			<div class="apiColumnTwo">
				...
				<img src="/img/wave2.png" id="allWaterIcon" />
				<p id="allWaterUsed">
		...
		<div class="row">
			<div class="columnOneRowOne">
				...
				<img src="/img/total_water1.png" id="totalWaterI" />
			</div>
			<div class="columnTwoRowOne" id="pink">
				<div class="columnTwoRowOneTop" id="green">
					<div class="columnTwoRowOnePackOneL">
						<img src="/img/light_drop.png" id="lightDrop" />
						<p>97% SALT WATER</p>
					</div>
					<div class="columnTwoRowOnePackOneL">
						<img src="/img/dark_drop.png" id="lightDrop" />
						<p>3% FRESH WATER</p>
					</div>
				</div>
	...
	<div class="row3">
		<div class="countDown">
			...
			<iframe title='Earth running out of freshwater'
				src='https://www.theworldcounts.com/embeds/counters/113?background_color=transparent&color=white&font_family=%22Helvetica+Neue%22%2C+Arial%2C+sans-serif&font_size=25'
				id="countDown"></iframe>
		</div>
	</div>
	<div class="internBackground">
		...
		<h2 class="titleGraph">RENEWABLE FRESHWATER RESOURCES PER CAPITA
			(2015)</h2>
		<div class="chart">
			<canvas id="myChart3"></canvas>
		</div>

		<h2 class="titleGraph" id="myGraph2">ANNUAL FRESHWATER
			WITHDRAWALS</h2>
		<div class="chart">
